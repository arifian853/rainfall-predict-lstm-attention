...
def predict():
    ...
    predictions_lstm = model_lstm.signatures['serving_default'](lstm_input=tf.constant(X))['dense'].numpy()
    predictions_lstm_attention = model_lstm_attention.signatures['serving_default'](input_1=tf.constant(X))['dense_1'].numpy()
