...
# Output file path
output_file_all_years = os.path.join(input_dir, '../final/final-data-2014-2024.csv')

# List to hold the yearly DataFrames
df_list = []

# Loop through the files in the directory
for year in range(2014, 2025):  # Adjust the range as needed
    ...
    if os.path.exists(input_file):
        ...
        df_year = pd.read_csv(input_file, parse_dates=['Tanggal'], index_col='Tanggal')
